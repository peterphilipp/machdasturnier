...
import versandauftragRoutes from './routes/versandauftrag.routes.js';
...
import bewertungsLinkRoutes from './routes/bewertungsLink.routes.js';
...
app.use('/api/versandauftraege', versandauftragRoutes);
...
app.use('/api/bewertung-link', bewertungsLinkRoutes);
