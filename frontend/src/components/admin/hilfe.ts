...
export const SEITENHILFE: Record<string, Seitenhilfe> = {
  ...
  statistik: {
    ...
    hinweise: [
      ...
      'Als Beteiligung zählt beides: übernommene Schichten UND Verpflegungsspenden. Wer Kuchen beisteuert, aber keine Schicht macht, steht deshalb nicht unter „Noch nicht dabei“. Stunden und Spenden bleiben getrennte Zahlen – vergleichbar sind sie nicht.',
