        ...
        <div className="station-print-preview-container">
          ...
          {statistik && (
            <>
              ...
              {/* Bleibt hochkant wie jedes andere Blatt - Querformat liess
                  sich im echten Druck-PDF nicht zuverlaessig herstellen,
                  siehe turnierabschluss.css. ShiftTimeline bekommt hier eine
                  eigene, kompaktere Druckdarstellung statt der breiten
                  Bildschirmversion. */}
